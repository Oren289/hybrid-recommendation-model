...
uri = "mongodb+srv://ilhanmahardikap:papamimi1308@cluster0.6phgimn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
ratings = ratings[['id', 'title', 'userId', 'rating']]
...
def recommend_collaborative(movies):
    ...
    for title, value in similar_movies.items():
        similar_movies_array.append((title, value))

    titles_only = similar_movies.index.tolist()
